...
public class ONGController {
	...
	@GetMapping("findAllAprovadas")
	public ResponseEntity<List<ONG>> findAllAprovadas() {
		List<ONG> ongs = ongService.findAllAprovadas();
		return new ResponseEntity<List<ONG>>(ongs, HttpStatus.OK);
	}
	...
	@PostMapping("create")
	public ResponseEntity<ONG> create(@RequestParam(value = "file", required = false) MultipartFile file,
	...
	public ResponseEntity<?> signin(@RequestBody ONG ong) {
		...
		ONG _ong = ongService.signin(ong.getEmail(), ong.getSenha());
	...
	public ResponseEntity<ONG> inativar(@PathVariable long id) {
	...
	@PutMapping
	public ResponseEntity<ONG> reativar(@PathVariable long id) {
	...
	public ResponseEntity<ONG> alterarSenha(@PathVariable long id, @RequestBody ONG ong) {
	...
	public ResponseEntity<ONG> alterarStatus(@PathVariable long id, @RequestBody ONG ong) {

		ONG _ong = ongService.alterarStatus(id, ong);
